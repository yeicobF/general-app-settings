" Este código es para cambiar el esquema de colores de vim a uno que descargué
" de internet: 
"   Humanoid - light and dark theme for vim with bright colors (hope some will like it)
"   https://www.reddit.com/r/vim/comments/k4nzz8/humanoid_light_and_dark_theme_for_vim_with_bright/
" Repositorio de donde saqué el código:
"   https://github.com/humanoid-colors/vim-humanoid-colorscheme/blob/main/colors/humanoid.vim
" - Copié y pegué el código siguiente:
...
call <sid>hi("StatusLine",    s:gui03, s:guiBG, s:cterm03, s:ctermBG, "NONE", "")
